...
export default function TimeEntry() {
  ...
  async function getTimeEntryPerDay(datePara: Date) {
    ...
    let formattedDate = datePara.toLocaleDateString("en-US", {timeZone: 'America/Halifax', year: 'numeric', month: '2-digit', day: '2-digit'});
    ...
    setTotalWorkingTime(Math.floor(n_totalTime-n_breakTime));
  ...
  async function getTimeEntryPerMonth(datePara: Date, forceRefresh: boolean) {
    ...
    let formattedDate = datePara.toLocaleDateString("en-US", {timeZone: 'America/Halifax', year: 'numeric', month: '2-digit'});
    const apiUrlEndpoint = 'api/fetchSql';
    const postData = {
        method: 'POST',
        headers: { 'Content-Type': 'application/json '},
